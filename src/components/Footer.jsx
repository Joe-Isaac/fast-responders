...
function Footer() {
  ...
  return (
    <Row className='w-full bg-[#000] text-white flex justify-between items-center'>
        <Col {...masterLayout} className='flex flex-col items-start justify-center'>
            <div className='w-full flex items-center justify-start my-2'>
              <img src={logo} alt="" className='w-40 my-4 rounded-full object-contain'/>
            </div>
          
        </Col>
        
        <Col xs={{span:24}} md={{span:18}} className='flex justify-center'>
        <Col span={14} className='flex flex-col justify-center items-start md:items-center'>
            <div className='my-2 flex items-center justify-center hover:text-white cursor-pointer space-x-2'>
              <div className='font-sans text-lg'>Our hotline number <a href='tel:0701 297753' className='text-2xl ml-2 text-blue-500 font-bold'>0701 297753</a></div>
            </div>
